...
#main variables
API_ID = int(environ.get('API_ID', '25223924'))
API_HASH = environ.get('API_HASH', '405f454daad6cacefc2c5cce7e3954a7')
BOT_TOKEN = environ.get('BOT_TOKEN', '7056848362:AAEPuSv1C69_Vf_tl52v_PVzSfTFOwY9TGM')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002290712212'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+4RB2-U2o9yE4ZmQ9')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002495500129').split()]
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://codingtrail10:owOWnDnS2d1IBTmj@cluster0.q2bst.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")

DATABASE_NAME = environ.get('DATABASE_NAME', "codingtrail10")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'aman_files')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002290712212'))
...
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002495500129'))
URL = environ.get('URL', 'mytestbot-jvdfhbj.com')
STICKERS_IDS = ('CAACAgQAAxkBAAEK99dlfC7LDqnuwtGRkIoacot_dGC4zQACbg8AAuHqsVDaMQeY6CcRojME').split()
FILE_AUTO_DEL_TIMER = int(environ.get('FILE_AUTO_DEL_TIMER', '600'))
IS_VERIFY = is_enabled('IS_VERIFY', True)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002304128075'))
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', 'None'))
